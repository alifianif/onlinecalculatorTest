...
public class onlinecalculator_squareroot_normalnumber_positivetest extends BasePage {
	...
	public void addition() throws Exception {
		...
		builder.sendKeys(Keys.NUMPAD4).perform();
		builder.sendKeys("@").perform();
		Thread.sleep(5000);	
		WebElement can = drivers.findElements(By.id("fullframe")).get(0);
		String filepath = "C:\\Users\\alifi\\workspace\\calculatorxendit\\test-sqr-normal-positive.png";
