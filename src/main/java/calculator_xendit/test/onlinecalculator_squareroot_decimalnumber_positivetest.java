...
public class onlinecalculator_squareroot_decimalnumber_positivetest extends BasePage {
	...
	public void addition() throws Exception {
		...
		builder.sendKeys(Keys.NUMPAD9).perform();
		builder.sendKeys(".").perform();
		builder.sendKeys(Keys.NUMPAD3).perform();
		builder.sendKeys("@").perform();
		Thread.sleep(5000);	
		WebElement can = drivers.findElements(By.id("fullframe")).get(0);
		String filepath = "C:\\Users\\alifi\\workspace\\calculatorxendit\\test-sqr-decimal-positive.png";
